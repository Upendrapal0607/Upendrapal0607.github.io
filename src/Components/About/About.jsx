  ...
  return (
    <div id="about" className="about section">
      ...
      <div>
        ...
        >
          <div id={style.first}>
            <Image className="home-img" src={myphoto} alt="Upendra Pal" />
          </div>
          ...
          <div className={style.aboutDetails}>
            ...
            <div className="aboutMe" id="user-detail-intro">
              <p className={style.namep}>
                A self-motivated passionate aspiring Full Stack Developer
                skilled in MERN stack, NodeJS,Redux,MongoDb molded and shaped by
                Masai School's numerous training. Actively ready to join the
                great living team of a good start-up to adapt me in any
                situation and the environment with ease and perform the best.
              </p>
            </div>

            <div id={style.resumeDiv} backgroundColor={"#BFACE0"}>
              <a
                id="resume-link-2"
